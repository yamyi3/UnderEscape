...
{
	vivid::DrawTexture("data\\文字関係\\コントローラー.png", vivid::Vector2((vivid::WINDOW_WIDTH / 2.0f - 587 / 2.0f), (vivid::WINDOW_HEIGHT / 2.0f - 993 / 2.0f)), 0xffffffff);
	vivid::DrawTexture("data\\文字関係\\閉じる白.png", vivid::Vector2((vivid::WINDOW_WIDTH / 2.0f - 235 / 2.0f), (vivid::WINDOW_HEIGHT / 3.0f * 2.0f)));
}
