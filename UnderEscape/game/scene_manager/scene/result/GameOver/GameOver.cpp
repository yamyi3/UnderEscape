...
void  GameOver::Draw()
{
	...
	vivid::DrawText(40, "がめおべらー", (result_pos - vivid::Vector2(-300, 200)), defult_color);
	vivid::DrawText(40, "やりなおしー", menu_pos[0],  defult_color);
	vivid::DrawText(40, "タイトール", (menu_pos[1]),  defult_color);
#endif
}
